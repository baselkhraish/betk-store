...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active"><a href="{{ route('admin.about') }}">about</a></li>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Edit Page About</h4>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <a href="{{ route('admin.about') }}" class="btn btn-success">View page about</a>
                            </div>
                        </div>
                    </div><!-- end card header -->
                        ...
                        <div class="live-preview">
                            <div class="row gy-12">
                                ...
                                <form action="{{ route('admin.about.update',$about->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-xxl-8 col-md-6 mb-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                id="basiInput" name="title" value="{{ old('title', $about->title) }}">
                                            @error('title')
                                    ...
                                    <div class="col-lg-8 mb-4">
                                        <div>
                                            ...
                                            <input class="form-control @error('image') is-invalid @enderror"
                                                id="formSizeDefault" type="file" name="image">
                                            @error('image')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            @enderror
                                            @if ($about->image)
                                                <img src="{{ asset('storage/' . $about->image) }}" height="60px">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-8 col-md-6 mb-4">
                                        <div>
                                            <label for="basiInput" class="form-label">Url Youtube</label>
                                            <input type="text" class="form-control @error('url') is-invalid @enderror"
                                                id="basiInput" name="url" value="{{ old('url', $about->url) }}">
                                            @error('url')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-xxl-8 col-md-6 mb-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control @error('description') is-invalid @enderror"
                                                id="basiInput" name="description" value="{{ old('description', $about->description) }}">
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <button type="submit"
                                            class="btn btn-success mt-3">{{ $button_lable ?? 'save' }}</button>
                                    </div>
