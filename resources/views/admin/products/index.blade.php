...
@section('search')
<!-- Search-->
<form class="app-search d-none d-md-block" action="{{ URL::current() }}" method="get">
            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        ...
                        btn btn-primary">Create</a>
                        <a href="{{ route('admin.products.trash') }}" class="
                        btn btn-danger">Trash</a>
                    </div>
                </div>
            </div><!-- end card header -->
                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            @forelse($products as $product)
                                <tr>
                                    ...
                                    <td><img src="{{asset('storage/'.$product->image)}}" alt="{{ $product->name }}" height="40px" ></td>
                                    <td>{{ $product->name }}</td>
