...
@section('search')
    ...
    <form class="app-search d-none d-md-block">
        <div class="position-relative" action="{{ URL::current() }}" method="get">
            <input type="text" class="form-control" placeholder="Search product..." autocomplete="off" id="search-options"
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Trash Products</h4>
                                            ...
                                            <div class="d-flex justify-content-right">
                                                <form action="{{ route('admin.products.restore', $product->id) }}"
                                                    ...
                                                    <input type="submit" value="Restore" class="btn btn-success"
                                                        style="margin-left: 15px" onclick="return confirm('are you sure?')">
                                                </form>
